...
module.exports = rapid => {
  ...
  return class Discover {
    ...
    _searchAndAdd(addMethod, patterns) {
      for(let pattern of patterns) { // Resolve patterns in the order they're passed
    ...
    routes(...patterns) {
      return this._searchAndAdd('addRoutes', patterns);
    }

    actions(...patterns) {
      return this._searchAndAdd('addActions', patterns);
    }
